...
sudo apt-get install -y openbox obconf rxvt-unicode firefox-esr pcmanfm nitrogen tint2 menu pulseaudio pavucontrol gnome-backgrounds mate-backgrounds mlocate lxappearance arandr apt-file synaptic firmware-linux firmware-linux-nonfree xutils mesa-utils xarchiver htop disk-manager wicd python3-pip python-pip deepin-icon-theme ttf-mscorefonts-installer fonts-ubuntu fonts-ubuntu-console suckless-tools simplescreenrecorder ranger geany gdebi lightdm fbxkb mpv curl gmrun xscreensaver brasero pnmixer sxiv scrot xsettingsd ffmpeg
